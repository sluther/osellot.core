<?php
class PageMenuItem_GatewayMenu_Setup_Osellot extends Extension_PageMenuItem {

	public function render() {
		$tpl = DevblocksPlatform::getTemplateService();
		$tpl->display('devblocks:osellot.core::configuration/section/gateway/menu_item.tpl');
	}
};

class Gateway_SetupSection_Osellot extends Extension_PageSection {
	...
	public function render() {
		...
		$tpl->display('devblocks:osellot.core::configuration/section/gateway/index.tpl');
	}
	...
	public function editGatewayAction() {
		...
		$tpl->display('devblocks:osellot.core::configuration/section/gateway/configure.tpl');
	}
