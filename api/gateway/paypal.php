...
class PayPal_Gateway extends Extension_Gateway_Osellot {
	...
	public function checkout() {
		$tpl = DevblocksPlatform::getTemplateService();
		$tpl->display('devblocks:osellot.core::gateway/paypal/checkout.tpl');
	}
	...
	public function processTransaction($order) {
		...
		$tpl->display('devblocks:osellot.core::gateway/paypal/process_transaction.tpl');
	}
	...
	public function configure() {
		...
		$tpl->display('devblocks:osellot.core::gateway/paypal/configure.tpl');
	}
}