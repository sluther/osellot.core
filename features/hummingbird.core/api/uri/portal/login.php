<?php
class LoginPortal_HummingbirdController extends Extension_Portal_Hummingbird_Controller {	
	function isVisible() {
		return true;
	}
	...
	function configure(Model_CommunityTool $instance) {
        ...
        $login_extensions_enabled = UmHbApp::getLoginExtensionsEnabled($instance->code);
        $tpl->assign('login_extensions_enabled', $login_extensions_enabled);
		
		$tpl->display("devblocks:hummingbird.core::portal/hb/config/module/login.tpl");
	}
	...
	function saveConfiguration(Model_CommunityTool $instance) {
		...
		DAO_CommunityToolProperty::set($instance->code, UmHbApp::PARAM_LOGIN_EXTENSIONS, implode(',', $login_extensions_enabled));
	}
