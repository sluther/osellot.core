...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" media="all" href="{devblocks_url}c=resource&p=osellot.core&f=portal/css/main.css{/devblocks_url}?v={$smarty.const.APP_BUILD}">
		<!--[if lt IE 9]>
		...
		<!--<![endif]-->
		<link rel="stylesheet" type="text/css" media="print" href="{devblocks_url}c=resource&p=osellot.core&f=portal/css/print.css{/devblocks_url}?v={$smarty.const.APP_BUILD}">
		<script src="{devblocks_url}c=resource&p=osellot.core&f=portal/js/modernizr-1.7.min.js{/devblocks_url}?v={$smarty.const.APP_BUILD}/"></script> 
		<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.6.2/jquery.min.js"></script> 
		<script src="{devblocks_url}c=resource&p=osellot.core&f=portal/js/scripts.js{/devblocks_url}?v={$smarty.const.APP_BUILD}"></script>
