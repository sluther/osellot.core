<?php
class AccountAgencyPortal_OsellotController extends Extension_Agency_Portal_Osellot_Controller {	
	public function writeResponse(DevblocksHttpResponse $response) {
		...
		switch($section) {
			case 'history':
				...
				$tpl->display('devblocks:osellot.core::portal/agency/account/history.tpl');
				break;
			default:
				$tpl->display('devblocks:osellot.core::portal/agency/account/index.tpl');
				break;
		}
	}
