<?php
class OrderAgencyPortal_OsellotController extends Extension_Agency_Portal_Osellot_Controller {
	public function writeResponse(DevblocksHttpResponse $response) {
		...
		switch($section) {
			case 'checkout':
				$tpl->display('devblocks:osellot.core::portal/agency/order/checkout.tpl');
				break;
			case 'confirm':
				...
				$tpl->display('devblocks:osellot.core::portal/agency/order/confirm.tpl');
				break;
			case 'process':
				$order = $umsession->getProperty('hb_order', null);
				if($order === null)
			...
			default:
				...
				$tpl->display('devblocks:osellot.core::portal/agency/order/index.tpl');
				break;
		}
	}
